...
namespace ModbusRTU_TP1608
{
    ...
    {
        public static F_DeviceManage f_DeviceManage;
        ...
        /// </summary>
        /// <returns></returns>
        public int tV_advice_rootNodeNum()
        {
        ...
        private void tV_advice_MouseDown(object sender, MouseEventArgs e)
        {
            //右击节点弹出菜单，根节点与子节点不同
            if (e.Button == MouseButtons.Right)
            {
                ...
                if (CurrentNode != null && CurrentNode.Bounds.Contains(e.X, e.Y))
                {
                    ...
                    {
                        F_DeviceManage.deviceName = CurrentNode.Text;
                        tV_advice.ContextMenuStrip = cMS_设备右键菜单;
                    }
                    //是子节点
                    else if (CurrentNode.Parent != null)
                    {
                        F_DeviceManage.chennalName = CurrentNode.Text;
